            ...
            value: function render() {
                ...
                return _react['default'].createElement(
                    ...
                    _react['default'].createElement(
                        'td',
                        { className: 'reactable-search-input', colSpan: this.props.colSpan },
                ...
                if (this.props.data && this.props.columns && typeof this.props.columns.map === 'function') {
                    ...
                    children = children.concat(this.props.columns.map((function (_ref, i) {
                        ...
                        if (this.props.data.hasOwnProperty(column.key)) {
                            ...
                            return _react['default'].createElement(
                                _td.Td,
                                _extends({ column: column, value: valueToPass, key: column.key }, props),
                                value
                            );
                        } else {
        ...
        _createClass(Paginator, [{
            ...
            value: function renderPrevious() {
                if (this.props.currentPage > 0) {
                    return _react["default"].createElement(
                        "li",
                        { key: this.props.currentPage - 1, className: "page-item" },
                        _react["default"].createElement(
                            "a",
                            { className: "page-link", href: pageHref(this.props.currentPage - 1), onClick: this.handlePrevious.bind(this) },
                            "Previous"
                        )
                    );
                }
            ...
            value: function renderNext() {
                if (this.props.currentPage < this.props.numPages - 1) {
                    return _react["default"].createElement(
                        ...
                        _react["default"].createElement(
                            "a",
                            { className: "page-link", href: pageHref(this.props.currentPage + 1), onClick: this.handleNext.bind(this) },
                            "Next"
                        )
                    );
                }
            ...
            value: function renderPageButton(className, pageNum) {
                return _react["default"].createElement(
                    "li",
                    { key: pageNum, className: "page-item " + className },
                    _react["default"].createElement(
                        "a",
                        { className: "page-link", onClick: this.handlePageButton.bind(this, pageNum), href: pageHref(pageNum) },
                        pageNum + 1
                    )
                );
            }
            ...
            value: function render() {
                ...
                var component = _react["default"].createElement(
                    "tbody",
                    ...
                    for (var filterColumn in this._filterable) {
                        if (typeof data[filterColumn] !== 'undefined') {
                            ...
                            if (typeof this._filterable[filterColumn] === 'undefined' || this._filterable[filterColumn] === 'default') {
                                var newData = (0, _libExtract_data_from.extractDataFrom)(data, filterColumn);
                                var comparisonString = newData;
                                if (newData.props) {
